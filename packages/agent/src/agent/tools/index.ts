...
export {registerTavilyTools, createTavilyWebSearchTool} from "./tavily/index.js";
...
import {registerTavilyTools} from "./tavily/index.js";
 ...
 * - Tavily tools (web_search_tavily): registered if TAVILY_API_KEY is available
 */
export function createBuiltinRegistry(env: Record<string, string>): ToolRegistry {
    ...
    registerTavilyTools(registry, env);
    return registry;
}
